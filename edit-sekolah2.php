<?php
  ...
  $sql="SELECT *FROM sekolahsmp WHERE nosmp='".$_GET['nosmp']."'"; 
  ...
  $sql="UPDATE sekolahsmp SET sekolahtujuan='".$_POST['sekolahtujuan'].
  "',"."kepala='".$_POST['kepala'].
  "',alamat='".$_POST['alamat'].
   "',"."telp='".$_POST['telp'].
  "'". "WHERE nosmp='".$_POST['nosmp']."'"; 
...
<html>
<head>
<title>EDIT DATA SEKOLAH MENENGAH PERTAMA</title>
...
<form name="form1" method="post" action="<?php $_SERVER['PHP_SELF']; ?>" onSubmit="return cek_data()"> 
  <table width="600" border="1 black" align="center" cellpadding="15" cellspacing="0" bgcolor="white">
    <tr>
      <td height="50" align="center" bgcolor="#5697ff"><strong><font color="#FFFFFF">EDIT DATA SEKOLAH MENENGAH PERTAMA</font></strong></td>
    </tr>
    <tr>
      <td><table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" bgcolor="#FFFFFF">
          <tr>
            ...
            <td width="9">:</td>
            <td width="287"><input name="nosmp" type="text" size="15" maxlength="20" value="<?php echo $row['nosmp']?>" readonly><font color="red">&nbsp;&nbsp;* Tidak dapat diganti</font></td></tr>
          <tr>
            <td>Nama Sekolah</td>
            <td>:</td>
            <td><input name="sekolahtujuan" type="text" id="sekolahtujuan" size="25" maxlength="25" value="<?php echo $row['sekolahtujuan']?>" readonly><font color="red">&nbsp;&nbsp;* Tidak dapat diganti</font></td></tr>       
          <tr>
          <tr>
