...
<form action="homeadmin.php?page=input-data-sekolah2" method="POST" name="form-input-data-sekolah2" enctype="multipart/form-data">
...
<td><input type="text" name="nosmp" size="20" maxlength="15" onkeypress="return hanyaAngka(event)"> </td>
</tr>
</tr>
<tr>
<td width="20" height="36">&nbsp;</td>
<td width="165">Nama Sekolah</td>
<td><input type="text" name="sekolahtujuan" size="40" maxlength="40"> </td>
</tr>
<tr>
<td height="36">&nbsp;</td>
