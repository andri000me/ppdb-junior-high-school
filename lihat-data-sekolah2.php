...
<div style="border:1px solid rgb(238,238,238); padding:10px; overflow:auto; width:136%; height:380; background-color: white;">
<a href='http:/ppdb/lap-sekolah2.php' style="float: right; padding-top: 30px; padding-right: 30px;" target="_blank" title="Simpan Dalam Format PDF"><img src="image/icon/pdf.png" width="30px" height="30px"></a>
<a href='homeadmin.php?page=form-input-data-sekolah2' style="float: right; padding-top: 30px; padding-right: 30px;" title="Tambah Data Baru"><img src="image/icon/add.png" width="30px" height="30px"></a>
...
<div align="center"></div></td>
<?php 
echo '<td><a href="edit-sekolah2.php?nosmp='.$hasil['nosmp'].'"><img src="image/icon/update.png" width="33" height="33"></a> &nbsp;&nbsp;&nbsp;
<a href="hapus-sekolah2.php?nosmp='.$hasil['nosmp'].'" onclick="return confirm(\'Yakin?\')"><img src="image/icon/delete.png" width="33" height="33"></a></td>';	//menampilkan link edit dan hapus dimana tiap link terdapat GET id -> ?id=siswa_id
?>
</tr>
<?php
}
