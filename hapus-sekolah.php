...
if(isset($_GET['nosd'])){
	...
	$cek = mysql_query("SELECT nosd FROM sekolah WHERE nosd='$nosd'") or die(mysql_error());
	...
	if(mysql_num_rows($cek) == 0){
		...
		$del = mysql_query("DELETE FROM sekolah WHERE nosd='$nosd'");
		...
		if($del){
			...
			alert('Data sekolah dasar berhasil dihapus !');
